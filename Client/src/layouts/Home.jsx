...
const Home = () => {
    ...
    const emailSubscritor = subscriptor ? subscriptor.email : localStorage.getItem('emailSubscribe')
    ...
    <div>
        {isLoading ?
            ...
            :<div> 
                ...
                <div className="flex-grow flex items-center justify-center lg:my-8">
                    <img src="/public/iconoColor.svg" alt="icono" className="w-16 h-auto m-2 animate-pulse"/>
